...
export default function FinalCTA() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In production, this would call your API / form handler
    setSubmitted(true);
  };
          ...
          >
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 px-6 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-all duration-200 shadow-lg shadow-indigo-600/30 hover:shadow-indigo-500/40 hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2"
                >
